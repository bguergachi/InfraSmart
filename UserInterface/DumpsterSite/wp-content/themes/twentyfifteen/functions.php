...
add_action( 'after_setup_theme', 'twentyfifteen_setup' );
 ...
 //ADDED SQL SCRIPT HERE 
 //require(dirname( __FILE__ ) . '/SQLtable-script.php' );
...
require get_template_directory() . '/inc/customizer.php';
 ...
 //ADDED SQL SCRIPT HERE 
 //require get_template_directory() . '/SQLtable-script.php';
 require(dirname( __FILE__ ) . '/SQLtable-script.php' );
 //require(dirname( __FILE__ ) . '/SQLtable-script2.php' );
 //require get_template_directory_uri() .'/SQLtable-script2.php';
